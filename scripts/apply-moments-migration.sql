...
SELECT '20260809_080000_moments', COALESCE((SELECT MAX(batch) FROM payload_migrations WHERE batch > 0), 1) + 1, now(), now()
WHERE NOT EXISTS (
  SELECT 1 FROM payload_migrations WHERE name = '20260809_080000_moments'
);
